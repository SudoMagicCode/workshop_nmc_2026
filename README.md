...
* Workshop TouchDesigner version - 2025.32280
...
The world of live entertainment is an ever-evolving landscape full of new technology and new techniques. For technicians and content creators alike, TouchDesigner is a tool that can help solve technical and creative problems alike. Whether you need a surefire way to create pixel maps, visualize data, or build your own production tools, TouchDesigner might well be the missing piece of your live production tool kit. This workshop will largely be focused on the intersection of art, design and the development of new tools for live performance.

This half day course is designed to introduce participants to the fundamental principles of TouchDesigner, a node-based programming environment, including an in-depth study of each operator family. Along with the basics, students will learn the fundamentals of creating their own tools, working with camera feeds, realtime rendering, and integrating with other systems using OSC.
